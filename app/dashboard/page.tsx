...
export default function DashboardHome() {
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      <div className="hidden sm:flex items-end justify-between flex-wrap gap-4">
        <div>
        ...
        <Link
          ...
          className="press text-sm font-semibold px-4 py-2 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700"
        >
          Ver agenda completa
        </Link>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        {stats.map((s) => (
          <div key={s.label} className="bg-white rounded-2xl p-4 sm:p-5 border">
            <div className="flex items-start justify-between">
              <div className={`w-9 h-9 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center ${s.color}`}>
